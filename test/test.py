...
parser.add_argument('--input_dir', default='/data/huang/datasets/cloud/clound-wy/RICE1/test/cloud/', type=str, help='Directory of input images or path of single image')
parser.add_argument('--input_truth_dir', default='/data/huang/datasets/cloud/clound-wy/RICE1/test/reference/', type=str, help='Directory of input images or path of single image')
parser.add_argument('--result_dir', default='./output/rice1-test', type=str, help='Directory for restored results')
parser.add_argument('--weights', default='experiments/rice1_DVPNet/models/net_g_25000.pth', type=str, help='Path to weights')
parser.add_argument('--opt', default='option/T-cloud-DVPNet.yml', type=str, help='Path to config yml file')
